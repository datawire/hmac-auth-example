...
type ExtAuthz struct {
	...
	// Note that this is currently available for the gRPC service *only*.
...
type HttpService struct {
	...
	AuthorizationHeadersToAdd []*envoy_api_v2_core.HeaderValue `protobuf:"bytes,6,rep,name=authorization_headers_to_add,json=authorizationHeadersToAdd" json:"authorization_headers_to_add,omitempty"`
}
...
func (m *HttpService) GetAuthorizationHeadersToAdd() []*envoy_api_v2_core.HeaderValue {
	if m != nil {
...
func (*ExtAuthzPerRoute) Descriptor() ([]byte, []int) { return fileDescriptorExtAuthz, []int{2} }
...
func (*CheckSettings) Descriptor() ([]byte, []int) { return fileDescriptorExtAuthz, []int{3} }
...
func (m *HttpService) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 6:
			...
			m.AuthorizationHeadersToAdd = append(m.AuthorizationHeadersToAdd, &envoy_api_v2_core.HeaderValue{})
...
var fileDescriptorExtAuthz = []byte{
	...
	,
}
