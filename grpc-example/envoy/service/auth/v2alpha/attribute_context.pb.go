...
type AttributeContext_HttpRequest struct {
	...
	// HTTP request body.
	Body *envoy_api_v2_core.DataSource `protobuf:"bytes,11,opt,name=body" json:"body,omitempty"`
}
...
func (m *AttributeContext_HttpRequest) GetBody() *envoy_api_v2_core.DataSource {
	if m != nil {
		return m.Body
	}
	return nil
...
func (m *AttributeContext_HttpRequest) MarshalTo(dAtA []byte) (int, error) {
	...
	if m.Body != nil {
		dAtA[i] = 0x5a
		i++
		i = encodeVarintAttributeContext(dAtA, i, uint64(m.Body.Size()))
...
var fileDescriptorAttributeContext = []byte{
	...
	,
}
